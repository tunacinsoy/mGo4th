// In my case, this program is located under `/home/tuna/go/src/github.com/tunacinsoy/mGo4th/ch06/sqlite06`
// The commands `go mod init` and `go mod tidy` should be run.
